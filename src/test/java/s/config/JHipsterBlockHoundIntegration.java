...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("s.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("s.security.DomainUserDetailsService", "createSpringSecurityUser");
