...
import s.config.SecurityConfiguration;
import s.config.SecurityJwtConfiguration;
import s.config.WebConfigurer;
import s.management.SecurityMetersService;
import s.web.rest.AuthenticateController;
