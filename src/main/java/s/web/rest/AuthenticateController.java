...
import static s.security.SecurityUtils.AUTHORITIES_CLAIM;
import static s.security.SecurityUtils.JWT_ALGORITHM;
import static s.security.SecurityUtils.USER_ID_CLAIM;
...
import s.security.DomainUserDetailsService.UserWithId;
import s.web.rest.vm.LoginVM;
