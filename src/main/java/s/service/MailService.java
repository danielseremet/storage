...
public class MailService {
    ...
    public MailService(
            ...
            MessageSource messageSource, UserRepository userRepository,
    ...
    public void sendStorageReservationSentMail(User user) {
        LOG.debug("Sending storage reservation sent email to");
        sendEmailFromTemplate(user, "mail/storageReservationSent", "email.request.title");
    }
